...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="./images/ricechecklg.svg" />
  </head>
  <body>
        ...
        <div class="main-panel">
                  ...
                  <div class="card-body">
                    ...
                    <div class="aligner-wrapper">
                      ...
                      <div class="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                        ...
                        <small class="d-block text-center text-muted  font-weight-semibold mb-0">WEATHER ANALYSIS</small>
                      </div>
                    </div>
                    <div class="wrapper mt-4 d-flex flex-wrap align-items-cente">
                      <div class="d-flex">
                        <span class="square-indicator bg-danger ml-2"></span>
                        <p class="mb-0 ml-2">Rain</p>
                      </div>
                      <div class="d-flex">
                        <span class="square-indicator bg-success ml-2"></span>
                        <p class="mb-0 ml-2">Cloudy</p>
                      </div>
                      <div class="d-flex">
                        <span class="square-indicator bg-warning ml-2"></span>
                        <p class="mb-0 ml-2">Sunshine</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body performane-indicator-card">
                    <div class="d-sm-flex">
                      <h4 class="card-title flex-shrink-1">Harvest Indicator</h4>
                      <p class="m-sm-0 ml-sm-auto flex-shrink-0">
                        <span class="data-time-range ml-0">7d</span>
                        <span class="data-time-range active">2w</span>
                        <span class="data-time-range">40mm</span>
                        <span class="data-time-range">30mm</span>
                        <span class="data-time-range">6omm</span>
                      </p>
                    </div>
                    <div class="d-sm-flex flex-wrap">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <p class="mb-0 ml-2 text-muted font-weight-semibold"> Concern (1123)</p>
                      </div>
                      <div class="d-flex align-items-center">
                        <span class="dot-indicator bg-danger ml-2"></span>
                        <p class="mb-0 ml-2 text-muted font-weight-semibold">Quality (876)</p>
                      </div>
                    </div>
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  ...
                  <div class="d-md-flex row m-0 quick-action-btns" role="group" aria-label="Quick action buttons">
                    ...
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" class="btn px-0"><i class="icon-docs mr-2"></i> Create Accounts</button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" class="btn px-0"><i class="icon-folder mr-2"></i> Enter Quiz</button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" class="btn px-0"><i class="icon-book-open mr-2"></i>Create answers</button>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Blogs</span>
                          <h4>$32123</h4>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Q and A</span>
                          <h4>95,458</h4>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Quality</span>
                          <h4>25,542</h4>
                    ...
                    <div class="table-responsive border rounded p-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>$3621</td>
                            <td><img src="images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> BLOG</td>
                            <td>04 Jun 2024</td>
                            <td>18 Jul 2024</td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>6245</td>
                            <td><img src="images/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Q AND A</td>
                            <td>25 Sep 2024</td>
                            <td>07 Oct 2024</td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>2263</td>
                            <td><img src="images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> Email</td>
                            <td>30 Sep 2019</td>
                            <td>20 Oct 2019</td>
                            <td>
                              <div class="badge badge-success p-2">Paid</div>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Rice Check, 2024 All rights reserved</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
